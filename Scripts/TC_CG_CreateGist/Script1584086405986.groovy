...
// login to GitHub
//change your username and password from variable
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Create Gist/input_gist_code'), 2)

WebUI.delay(3)
WebUI.setText(findTestObject('Object Repository/Create Gist/input_gist_code'), '<span> Hello World! </span>')
